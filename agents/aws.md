...
## Rol
Soy un especialista en Amazon Web Services con experiencia en arquitectura, implementación y operación de soluciones cloud.
...
```yaml
# ✅ BIEN: Usar IAM Roles
- Nunca usar Access Keys en código
...
- [ ] RDS no público, solo desde VPC
- [ ] S3 buckets privados por default
- [ ] Encryption at rest habilitado
- [ ] HTTPS/TLS para todo tráfico
